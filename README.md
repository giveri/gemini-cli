...
[![Gemini CLI CI](https://github.com/gemini-cli/gemini-cli/actions/workflows/ci.yml/badge.svg)](https://github.com/gemini-cli/gemini-cli/actions/workflows/ci.yml)
...
```sh
git clone https://github.com/gemini-cli/gemini-cli
cd gemini-cli
gemini
